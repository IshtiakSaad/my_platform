...
Historical examples demonstrate the contingency of majors on underlying problems:

- **Clerical occupations**: Typists, telegraph operators, and travel agents once justified entire curricula. Advances in software and online platforms solved the underlying information-processing and booking problems, leading to the decline or transformation of related academic programs [2][3].
- **Labor polarization**: Autor et al. document the decline of routine middle-skill jobs and the rise of non-routine cognitive roles. Majors producing skills for obsolete tasks lost relevance, while those cultivating problem-solving abilities retained or increased value [4].
- **Limited complete obsolescence**: Entire occupations rarely vanish; tasks migrate. Bookkeeping evolved into database management, illustrating how majors tied to disappearing problems must adapt or fade [4].

These examples reveal a central principle: **majors survive only if the problems they address persist or evolve**.

## Emergence of New Majors and Problem Classes

Novel societal and technological challenges create new problem classes, spawning new academic programs:

- **Cybersecurity, data science, AI ethics**: These fields arose in response to emerging digital threats, big-data analytics, and algorithmic decision-making. Educational programs followed the problem, not the other way around [5].
...
Relying on degrees alone to predict labor-market outcomes is flawed. Empirical studies find pervasive mismatch between education and employment, with many graduates working in roles unrelated to their majors [6]. Rapid changes in technology and the economy often outpace curriculum adaptation, creating underemployment or skill underutilization [7]. Conzelmann et al. (2024) show that even when universities adjust programs, there is a measurable lag between problem emergence and academic response [7]. Thus, **majors are an imperfect proxy for future employability unless tied to evolving problem-solving needs**.
...
1. Acemoglu, D., & Restrepo, P. (2019). *Automation and New Tasks: How Technology Displaces and Reinstates Labor.* American Economic Association.
2. Bessen, J. (2020). *Automation and jobs: when technology boosts employment.* Economic Policy, Oxford Academic.
3. Bessen, J. E. (2016). *How Computer Automation Affects Occupations: Technology, Jobs, and Skills.* SSRN.
4. World Economic Forum. (2017). *One career automation has totally eliminated in 60 years.*
5. Journal of Technology Transfer. (2022). *Does updating education curricula accelerate technology adoption in the workplace? Evidence from Switzerland.*
6. Social Indicators Research. (2016). *Measuring Occupational Mismatch: Overeducation and Overskill in Europe.*
7. Conzelmann, J., Hemelt, S. W., et al. (2024). *Skills, Majors, and Jobs: Does Higher Education Respond?* Upjohn Institute Working Paper.